...
parameters{
  ...
  real<lower =  0.5475, upper = 1.6425> beta1;
  real<lower =  0.5237, upper = 1.5710> beta2;
  real<lower =  0.2452, upper = 0.7356> beta3;
  real<lower =  0.7476, upper = 2.2427> beta4;
  real<lower =  0.0714, upper = 0.5> kappa1;
  real<lower =  0.0714, upper = 0.5> kappa2;
  real<lower =  0.0714, upper = 0.5> kappa3;
  real<lower =  0.0714, upper = 0.5> kappa4;
  real<lower =  0.0641, upper = 1.5> gamma1;
  real<lower =  0.0641, upper = 1.5> gamma2;
  real<lower =  0.0641, upper = 1.5> gamma3;
  real<lower =  0.0641, upper = 1.5> gamma4;
  //real<lower =  5e-7, upper = 10> nu1;
  //real<lower =  5e-7, upper = 10> nu2;
  //real<lower =  5e-7, upper = 10> nu3;
  //real<lower =  5e-7, upper = 10> nu4;
  real<lower =  0.1, upper = 10> nu1_inv;
  real<lower =  0.1, upper = 10> nu2_inv;
  real<lower =  0.1, upper = 10> nu3_inv;
  real<lower =  0.1, upper = 10> nu4_inv;
  real<lower =  50, upper = 100> E01;
  real<lower =  70, upper = 100> E02;
  real<lower =  15, upper = 50> E03;
  real<lower =  0, upper = 20> E04;
...
model{  
  // Prior distributions
  beta1    ~ lognormal(-0.0529, 0.2803);
  beta2    ~ lognormal(-0.0975, 0.2804);
  beta3    ~ lognormal(-0.8562, 0.2803);
  beta4    ~ lognormal(0.2583, 0.2803);
  kappa1   ~ gamma(4.5264, 19.1006);
  kappa2   ~ gamma(4.5264, 19.1006);
  kappa3   ~ gamma(4.5264, 19.1006);
  kappa4   ~ gamma(4.5264, 19.1006);
  gamma1    ~ gamma(1.9826, 3.6943);
  gamma2    ~ gamma(1.9826, 3.6943);
  gamma3    ~ gamma(1.9826, 3.6943);
  gamma4    ~ gamma(1.9826, 3.6943);
  nu1_inv ~ gamma(0.5761, 0.2714);
  nu2_inv ~ gamma(0.5761, 0.2714);
  nu3_inv ~ gamma(0.5761, 0.2714);
  nu4_inv ~ gamma(0.5761, 0.2714);
  //nu1 ~ gamma(0.5761, 0.2714);
  //nu2 ~ gamma(0.5761, 0.2714);
  //nu3 ~ gamma(0.5761, 0.2714);
  //nu4 ~ gamma(0.5761, 0.2714);
  E01      ~ uniform(50, 100.);
  E02      ~ uniform(70., 100.);
  E03      ~ uniform(15., 50.);
  E04      ~ uniform(0., 20.);
